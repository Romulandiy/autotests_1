...
# hive table names
HIVE_SNAPSHOT_TABLE = DATA_CONF['hive_table_names'][0]  # test_frs_kbn_orclcdb__cust_qa_snapshot_orig
HIVE_INC_ID_TABLE = DATA_CONF['hive_table_names'][1]  # test_frs_kbn_orclcdb__cust_qa_inc_id_orig
HIVE_INC_DATE_TABLE = DATA_CONF['hive_table_names'][2]  # test_frs_kbn_orclcdb__cust_qa_inc_date_orig
HIVE_INC_ID_DATE_TABLE = DATA_CONF['hive_table_names'][3]  # test_frs_kbn_orclcdb__cust_qa_inc_id_date_orig
HIVE_INC_ID_BELOW_HWM_DATE_TABLE = DATA_CONF['hive_table_names'][4]  # test_frs_kbn_orclcdb__cust_qa_inc_id_below_hwm_date_orig
HIVE_INC_ID_HIGHER_HWM_DATE_TABLE = DATA_CONF['hive_table_names'][5]  # test_frs_kbn_orclcdb__cust_qa_inc_id_higher_hwm_date_orig
HIVE_FIVE_DAYS_SNAPSHOT_TABLE = DATA_CONF['hive_table_names'][6]  # test_frs_kbn_orclcdb__cust_qa_five_days_snapshot_orig
HIVE_INC_ID_WITH_WAIT_FOR_SIXTY_DATE_TABLE = DATA_CONF['hive_table_names'][7]  # test_frs_kbn_orclcdb__cust_qa_inc_id_with_wait_for_sixty_date_orig
HIVE_INC_ID_WITH_SKIP_GAP_TABLE = DATA_CONF['hive_table_names'][8]  # test_frs_kbn_orclcdb__cust_qa_inc_id_with_skip_gap_orig
HIVE_INC_ID_WITH_FETCH_NEXT_TABLE = DATA_CONF['hive_table_names'][9]  # test_frs_kbn_orclcdb__cust_qa_inc_id_with_fetch_next_orig
HIVE_INC_ID_WITH_THREAD_NUM_TABLE = DATA_CONF['hive_table_names'][10]  # test_frs_kbn_orclcdb__cust_qa_inc_id_with_thread_num_orig
HIVE_INC_ID_DATE_PROBABLY_1_TABLE = DATA_CONF['hive_table_names'][11]  # test_frs_kbn_orclcdb__cust_qa_inc_id_date_probably_1_orig
HIVE_INC_ID_DATE_SOURCE_MULTI_THREAD_1_TABLE = DATA_CONF['hive_table_names'][12] # test_frs_kbn_orclcdb__cust_qa_inc_id_date_source_multi_thread_1_orig
...
class Test:
    ...
    def test_check_generation_not_create_ddl_scripts(self):
        expected_result = 'Execute query: create table if not exists test_frs_kbn_ORCLCDB__CUST_QA_snapshot_orig('
    ...
    def test_check_concurrent_loaded_data_of_single_table(self):
        ...
        assert 'Table test_frs_kbn_ORCLCDB__CUST_QA_snapshot_orig is locked by user' in str(p)
    ...
    def test_check_message_probably_incompleted_partition(self, hive):
        expected_result = 'Incompleted partition for test_frs_kbn_ORCLCDB__CUST_QA_inc_id_date_probably_1_orig: ' \
